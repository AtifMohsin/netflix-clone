...
const Signup = () => {
  ...
  return (
    ...
    <div className=' flex flex-col justify-center  mt-16 mx-4 sm:mx-20 '>
      ...
      <h1 className='text-3xl font-bold font-nsans-small ' > Sign Up</h1>
      <form onSubmit={handleSubmit} className='flex flex-col gap-10 mt-10' action='' method=''>
        ...
        value={password}
         ...
         <button className=" font-nsans-small w-full bg-red-600 p-4 rounded-sm" type='submit' > Sign Up</button>
      ...
      <p className='text-gray-500 text-sm font-nsans-light mt-4 pl-2  '> Already a member? <a className="text-white cursor-pointer">Sign In.</a></p>
      </div>
